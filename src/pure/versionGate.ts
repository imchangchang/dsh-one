 ...
 * （区间内；图标名换代与名册基线参数编码两个根因已修，整轮仍有 26 条红，2026-09-24 逐条
 * 定性见 #244：21 条是判据钉了 0.1.6 形状、0 条确认产品坏、5 条未定性）。这一层缺口见
 * `docs/dsh-compat-checklist.md` 的「版本门」一节，等#234 的后续条目定夺要不要加已知
 * 不可用的名单。
 */
