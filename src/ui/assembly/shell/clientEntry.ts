/**
 * @dsh-one/vscode-shell 的 esbuild 入口：build.mjs 用 banner/footer 把本
 * bundle 包成官方自注册形态——
 *   window.__ModuleLoader__.load({ id: "@dsh-one/vscode-shell",
 ...
 */
export { apply, inject } from './shellPlugin.ts'
