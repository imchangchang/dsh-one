/**
 * @dsh-one/vscode-chat-ui-layout 的 esbuild 入口：build.mjs 用 banner/footer 把本
 * bundle 包成官方自注册形态——
 *   window.__ModuleLoader__.load({ id: "@dsh-one/vscode-chat-ui-layout",
 ...
 */
export { apply, inject } from './chatLayoutPlugin.ts'
