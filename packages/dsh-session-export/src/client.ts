/**
 * `@dsh-one/dsh-session-export` 的浏览器侧入口。
 *
 * 插件本体住在仓库的共享源码里（`src/ui/assembly/shell/sessionExportPlugin`），
 ...
 */
export { apply, inject } from '../../../src/ui/assembly/shell/sessionExportPlugin.ts'
