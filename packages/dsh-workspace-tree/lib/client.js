...
function useHoverCardRoom(rootRef) {
  const [room, setRoom] = (0, import_react.useState)(false);
...
function SessionStatusDots({ statuses, tr }) {
  ...
  return (0, import_react.createElement)("span", { className: "dshOneTree_slot" }, (0, import_react.createElement)(import_dsh_client_ui_primitives.StateDot, { state: statuses[0].state, className: "dshOneTree_dot" }), labels);
}
function SessionHoverContent({ node, now, tr }) {
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)("div", { className: "dshOneTree_hoverTitle" }, displayTitle(node, tr)),
    node.blank ? null : (0, import_react.createElement)("div", { className: "dshOneTree_hoverTime" }, hoverTimeLabel(node.updatedAt, now, tr)),
    statuses.map(
      (status) => (0, import_react.createElement)(
        "div",
        { className: "dshOneTree_hoverStatus", key: status.labelKey },
        (0, import_react.createElement)(import_dsh_client_ui_primitives.StateDot, { state: status.state }),
        (0, import_react.createElement)("span", null, status.labelCount === void 0 ? tr(status.labelKey) : tr(status.labelKey, { n: status.labelCount }))
      )
    )
  );
}
function WorkspaceHoverContent({
  ...
  return (0, import_react.createElement)(
    "div",
    { className: "dshOneTree_hoverContent" },
    (0, import_react.createElement)("div", { className: "dshOneTree_hoverTitle" }, label),
    cwd === void 0 ? null : (0, import_react.createElement)("div", { className: "dshOneTree_hoverPath" }, cwd),
    createdAt === void 0 ? null : (0, import_react.createElement)("div", { className: "dshOneTree_hoverTime" }, createdLabel(createdAt, tr))
  );
}
function ProjectRow({
  group,
  ...
  const menuItems = onRename === void 0 || onDelete === void 0 ? null : [
    { id: "rename", label: tr("rename"), icon: (0, import_react.createElement)(import_dsh_client_ui_primitives.IconEditOutline16, {}) },
    { id: "delete", label: tr("delete.workspace"), icon: (0, import_react.createElement)(import_dsh_client_ui_primitives.IconTrashOutline16, {}), danger: true },
    ...groupItems
  ];
  const anchor = (0, import_react.createElement)(
    "button",
    {
      type: "button",
  ...
  const row = (0, import_react.createElement)(
    "div",
    {
      ...
      children: [
        (0, import_react.createElement)(
          "span",
          {
            ...
            children: expanded ? (0, import_react.createElement)(import_dsh_client_ui_primitives.IconFolderOpen16, {}) : (0, import_react.createElement)(import_dsh_client_ui_primitives.IconFolderClose16, {})
          }
        ),
        (0, import_react.createElement)("span", {
          key: "chevron",
          className: "dshOneTree_slot dshOneTree_chevron",
          children: (0, import_react.createElement)(import_dsh_client_ui_primitives.IconTriangleRightFill14, {
        ...
        (0, import_react.createElement)("span", {
          ...
          children: (0, import_react.createElement)("span", { className: "dshOneTree_title" }, label)
        }),
        counts === void 0 ? null : (0, import_react.createElement)(ActivityBadge, { key: "activity", counts, tr }),
        (0, import_react.createElement)("span", {
          key: "actions",
          className: "dshOneTree_rowActions",
          children: [
            menuItems === null ? null : (0, import_react.createElement)(import_dsh_client_ui_primitives.Menu, {
              key: "menu",
              open: menuOpen,
            ...
            (0, import_react.createElement)(
              ...
              (0, import_react.createElement)(import_dsh_client_ui_primitives.IconPlusOutline16, {})
            )
          ]
        })
      ]
  ...
  return (0, import_react.createElement)(import_dsh_client_ui_primitives.HoverCard, {
    anchor: row,
    content: (0, import_react.createElement)(WorkspaceHoverContent, { label: group.label, cwd: group.cwd, createdAt: group.createdAt, tr }),
    disabled: menuOpen,
    copyText: group.cwd,
    copyLabel: tr("copy"),
...
function SessionRow({
  ...
  const [menuOpen, setMenuOpen] = (0, import_react.useState)(false);
  const [menuAt, setMenuAt] = (0, import_react.useState)(null);
  ...
  const openInNewTabItem = onOpenInNewTab === void 0 ? [] : [
    {
      ...
      label: (0, import_react.createElement)("span", { "data-dshone-tree-item": "openInNewTab" }, tr("menu.openInNewTab")),
      // 图标取官方 primitives 的 IconRightUpOutline16（向右上离开方框 = 到别处打开），
      // 与官方行菜单项同为 16 档、同为 icon 槽位的次级色。
      icon: (0, import_react.createElement)(import_dsh_client_ui_primitives.IconRightUpOutline16, {})
    }
  ];
  const menuItems = [
    { id: "rename", label: tr("rename"), icon: (0, import_react.createElement)(import_dsh_client_ui_primitives.IconEditOutline16, {}) },
    { id: "fork", label: tr("menu.fork"), icon: (0, import_react.createElement)(import_dsh_client_ui_primitives.IconBranchOutline16, {}) },
    ...openInNewTabItem,
    { id: "archive", label: tr("menu.archiveSession"), icon: (0, import_react.createElement)(import_dsh_client_ui_primitives.IconArchiveOutline20, { size: 16 }) }
  ];
  const anchor = (0, import_react.createElement)(
    "button",
    {
  ...
  const row = (0, import_react.createElement)(
    "div",
    {
      ...
      children: [
        selectMode ? (0, import_react.createElement)("span", { key: "check", className: "dshOneTree_check" }, (0, import_react.createElement)(SelectMark, { on: selected })) : !flat || showStatus ? showStatus ? (0, import_react.createElement)(SessionStatusDots, { key: "status", statuses, tr }) : (0, import_react.createElement)("span", { key: "status", className: "dshOneTree_slot" }) : null,
        (0, import_react.createElement)("span", { key: "title", className: "dshOneTree_title" }, title),
        node.blank || selectMode ? null : (0, import_react.createElement)("span", {
          key: "time",
        ...
        node.blank || selectMode ? null : (0, import_react.createElement)("span", {
          key: "actions",
          className: "dshOneTree_rowActions",
          children: (0, import_react.createElement)(import_dsh_client_ui_primitives.Menu, {
            open: menuOpen,
            onClose: () => {
              setMenuAt(null);
              setMenuOpen(false);
  ...
  return (0, import_react.createElement)(import_dsh_client_ui_primitives.HoverCard, {
    anchor: row,
    content: (0, import_react.createElement)(SessionHoverContent, { node, now, tr }),
    disabled: menuOpen,
    ...
    "button",
    {
      ...
      children: [
        (0, import_react.createElement)("span", {
          ...
          children: [
            showStatus ? (0, import_react.createElement)(SessionStatusDots, { key: "status", statuses, tr }) : (0, import_react.createElement)("span", { key: "status", className: "dshOneTree_slot" }),
            (0, import_react.createElement)("span", { key: "title", className: "dshOneTree_searchRowTitle" }, displayTitle(node, tr))
          ]
        }),
        (0, import_react.createElement)("span", {
          key: "meta",
          ...
          children: [
            (0, import_react.createElement)("span", { key: "ws", className: "dshOneTree_searchRowWorkspace" }, workspaceLabel || tr("group.ungrouped")),
            snippet === void 0 || snippet === "" ? null : (0, import_react.createElement)("span", { key: "snip", className: "dshOneTree_searchRowSnippet" }, snippet)
          ]
        })
      ]
    }
...
function ViewOptionsMenu({
  ...
  return (0, import_react.createElement)(import_dsh_client_ui_primitives.Menu, {
    ...
    dense: true,
    portal: true,
    anchor: (0, import_react.createElement)(import_dsh_client_ui_primitives.Tooltip, {
      ...
      children: (0, import_react.createElement)(
        ...
        (0, import_react.createElement)(import_dsh_client_ui_primitives.IconPersonalizationOutline16, {})
      )
    })
  });
}
...
function ActivityBadge({ counts, tr }) {
  return (0, import_react.createElement)(
    ...
    counts.running > 0 ? (0, import_react.createElement)(
      "span",
      { className: "dshOneTree_activityItem", "data-dshone-tree-running": counts.running, title: tr("activity.running", { n: counts.running }) },
      (0, import_react.createElement)(import_dsh_client_ui_primitives.StateDot, { state: "ongoing" }),
      String(counts.running)
    ) : null,
    counts.waiting > 0 ? (0, import_react.createElement)(
      "span",
      { className: "dshOneTree_activityItem", "data-dshone-tree-waiting": counts.waiting, title: tr("activity.waiting", { n: counts.waiting }) },
      (0, import_react.createElement)(import_dsh_client_ui_primitives.StateDot, { state: "warning" }),
...
function SelectMark({ on }) {
  return (0, import_react.createElement)(
    ...
    on ? (0, import_react.createElement)(import_dsh_client_ui_primitives.IconCheckOutline16, { size: 12 }) : null
  );
}
function SelectionBar({
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)(
      ...
      (0, import_react.createElement)("span", { className: "dshOneTree_selectionCount" }, count === 0 ? tr("select.none") : tr("select.count", { n: count })),
      (0, import_react.createElement)(
    ...
    error === null ? null : (0, import_react.createElement)("div", { className: "dshOneTree_selectionError", role: "alert" }, error)
  );
}
function RecycleDrawer({
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)(
      ...
      (0, import_react.createElement)("span", { className: "dshOneTree_drawerTitle" }, tr("recycle.title")),
      (0, import_react.createElement)(
        "button",
        {
          type: "button",
        ...
        (0, import_react.createElement)(import_dsh_client_ui_primitives.IconCloseFill14, {})
      )
    ),
    total === 0 ? (0, import_react.createElement)("div", { className: "dshOneTree_drawerStatus" }, tr("recycle.empty")) : (0, import_react.createElement)(
      "div",
      { className: "dshOneTree_drawerList" },
      groups.map(
        (group) => (0, import_react.createElement)(
          "div",
          { className: "dshOneTree_drawerGroup", key: group.key, "data-dshone-recycle-group": group.key },
          (0, import_react.createElement)("div", { className: "dshOneTree_drawerGroupLabel" }, group.workspaceId === void 0 ? tr("group.ungrouped") : group.label),
          group.sessions.map((node) => {
            ...
            return (0, import_react.createElement)(
              ...
              (0, import_react.createElement)("span", { className: "dshOneTree_time" }, timeLabel(node.updatedAt, now, tr)),
              (0, import_react.createElement)(
                "button",
                {
                  type: "button",
                ...
                (0, import_react.createElement)(import_dsh_client_ui_primitives.IconRefreshOutline16, { size: 14 }),
...
function GroupModal({
  ...
  const lastOpen = (0, import_react.useRef)(false);
  (0, import_react.useEffect)(() => {
  ...
  if (kind === "delete") {
    return (0, import_react.createElement)(import_dsh_client_ui_primitives.Modal, {
      open,
      onClose,
      closeLabel: tr("close"),
      ...
      footer: (0, import_react.createElement)(
        ...
        (0, import_react.createElement)(import_dsh_client_ui_primitives.Button, { variant: "outline", disabled: busy, onClick: onClose }, tr("cancel")),
        (0, import_react.createElement)(
          import_dsh_client_ui_primitives.Button,
          {
            variant: "outline",
      ...
      children: error === null ? null : (0, import_react.createElement)("div", { className: "dshOneTree_renameError", role: "alert" }, error)
    });
  }
  return (0, import_react.createElement)(import_dsh_client_ui_primitives.Modal, {
    open,
    ...
    children: [
      ...
      nameError === null && error === null ? null : (0, import_react.createElement)("div", { className: "dshOneTree_renameError", role: "alert" }, nameError ?? error)
    ]
  });
}
function RenameModal({
  ...
  return (0, import_react.createElement)(import_dsh_client_ui_primitives.Modal, {
    ...
    footer: (0, import_react.createElement)(
      ...
      { style: { display: "flex", gap: "8px" } },
      (0, import_react.createElement)(import_dsh_client_ui_primitives.Button, { variant: "outline", disabled: busy, onClick: onClose }, tr("cancel")),
      (0, import_react.createElement)(import_dsh_client_ui_primitives.Button, { variant: "primary", disabled: busy || draft.trim() === "", onClick: commit }, tr("rename"))
    ),
    children: [
      (0, import_react.createElement)("input", {
        className: "dshOneTree_renameInput",
      ...
      error === null ? null : (0, import_react.createElement)("div", { className: "dshOneTree_renameError", role: "alert" }, error)
    ]
  });
}
function DeleteWorkspaceModal({
  ...
  return (0, import_react.createElement)(import_dsh_client_ui_primitives.Modal, {
    ...
    footer: (0, import_react.createElement)(
      ...
      { style: { display: "flex", gap: "8px" } },
      (0, import_react.createElement)(import_dsh_client_ui_primitives.Button, { variant: "outline", disabled: busy, onClick: onClose }, tr("cancel")),
      (0, import_react.createElement)(import_dsh_client_ui_primitives.Button, { variant: "outline", disabled: busy, onClick: commit, className: "dshOneTree_deleteAction" }, tr("delete.workspace"))
    ),
    children: [
      busy ? (0, import_react.createElement)("div", { className: "dshOneTree_deleteStatus", role: "status" }, tr("delete.pending")) : null,
      error === null ? null : (0, import_react.createElement)("div", { className: "dshOneTree_renameError", role: "alert" }, error)
    ]
  });
}
...
function WorkspaceTree(props) {
  ...
  const [prefs, setPrefs] = (0, import_react.useState)(readTreeViewPrefs(pageStorage()));
  ...
  const [content, setContent] = (0, import_react.useState)(EMPTY_SEARCH);
  const [renameTarget, setRenameTarget] = (0, import_react.useState)(null);
  const [sessionRenameTarget, setSessionRenameTarget] = (0, import_react.useState)(null);
  const [deleteTarget, setDeleteTarget] = (0, import_react.useState)(null);
  const [groupsFile, setGroupsFile] = (0, import_react.useState)(emptyTreeGroups());
  const [groupDialog, setGroupDialog] = (0, import_react.useState)(null);
  const [groupError, setGroupError] = (0, import_react.useState)(null);
  const [selectMode, setSelectMode] = (0, import_react.useState)(false);
  const [selection, setSelection] = (0, import_react.useState)([]);
  const [archiving, setArchiving] = (0, import_react.useState)(false);
  ...
  const [restoringId, setRestoringId] = (0, import_react.useState)(null);
  const [recycleError, setRecycleError] = (0, import_react.useState)(null);
  const searchInput = (0, import_react.useRef)(null);
  const searchRoot = (0, import_react.useRef)(null);
  const rootRef = (0, import_react.useRef)(null);
  const hoverCard = useHoverCardRoom(rootRef);
  (0, import_react.useEffect)(() => {
    writeTreeViewPrefs(pageStorage(), prefs);
  }, [prefs]);
  const groupsLoaded = (0, import_react.useRef)(false);
  (0, import_react.useEffect)(() => {
  ...
  const treeBody = trimmedQuery !== "" ? searchRows.length > 0 ? (0, import_react.createElement)(
    "div",
    { className: "dshOneTree_searchTree", role: "tree", "aria-label": tr("search.results.aria"), "data-dshone-tree": "search" },
    searchRows.map(
      (row) => (0, import_react.createElement)(SearchResultRow, {
        key: row.id,
        node: row,
  ...
  ) : content.pending ? (0, import_react.createElement)("div", { className: "dshOneTree_searchStatus" }, tr("search.pending")) : (0, import_react.createElement)(
    "div",
    { className: "dshOneTree_searchStatus" },
    content.failed ? tr("search.unavailable") : tr("search.noMatches")
  ) : groupBy === "flat" ? (0, import_react.createElement)(
    "div",
    { className: "dshOneTree_flatList", role: "tree", "data-dshone-tree": "flat" },
    flatRows.map(
      (row) => (0, import_react.createElement)(SessionRow, {
        key: row.id,
        node: row,
    ...
    groups.map(
      (group) => (0, import_react.createElement)(
        ...
        (0, import_react.createElement)(ProjectRow, {
          group,
          tr,
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)(
        ...
        (0, import_react.createElement)(
          ...
          (0, import_react.createElement)(import_dsh_client_ui_primitives.Tooltip, {
            ...
            children: (0, import_react.createElement)(
              ...
              (0, import_react.createElement)(import_dsh_client_ui_primitives.IconSearchOutline16, { size: searchExpanded ? 11 : 14 })
            )
          }),
          (0, import_react.createElement)("input", {
            ref: searchInput,
          ...
          searchExpanded ? (0, import_react.createElement)(
            "button",
            {
              type: "button",
      ...
      (0, import_react.createElement)(
        ...
        (0, import_react.createElement)(ViewOptionsMenu, {
          groupBy,
          orderBy,
          tr,
        ...
        (0, import_react.createElement)(import_dsh_client_ui_primitives.Tooltip, {
          ...
          children: (0, import_react.createElement)(
            ...
            (0, import_react.createElement)(import_dsh_client_ui_primitives.IconChecklistOutline14, { size: 16 })
          )
        }),
        (0, import_react.createElement)(import_dsh_client_ui_primitives.Tooltip, {
          ...
          children: (0, import_react.createElement)(
            ...
            (0, import_react.createElement)(import_dsh_client_ui_primitives.IconArchiveOutline20, { size: 16 })
          )
        }),
        directoryFlowAvailable ? (0, import_react.createElement)(import_dsh_client_ui_primitives.Tooltip, {
          ...
          children: (0, import_react.createElement)(
            ...
            (0, import_react.createElement)(import_dsh_client_ui_primitives.IconPlusOutline16, { size: 16 })
          )
        }) : null
      )
    ),
    (0, import_react.createElement)(
      ...
      groupBy === "workspace" && trimmedQuery === "" && !selectMode ? (0, import_react.createElement)(GroupFilterBar, {
        groups: treeGroupDefs(groupsFile),
      ...
      selectMode ? (0, import_react.createElement)(SelectionBar, {
      ...
      (0, import_react.createElement)(
        ...
        workspacePhase !== "ready" ? null : groups.length === 0 && trimmedQuery === "" ? (0, import_react.createElement)("div", { className: "dshOneTree_empty" }, tr("empty.none")) : treeBody
      )
    ),
    (0, import_react.createElement)(RecycleDrawer, {
      open: drawerOpen,
    ...
    (0, import_react.createElement)(RenameModal, {
    ...
    (0, import_react.createElement)(GroupModal, {
      dialog: groupDialog,
      groups: treeGroupDefs(groupsFile),
      tr,
      error: groupError,
    ...
    (0, import_react.createElement)(DeleteWorkspaceModal, {
      target: deleteTarget,
      tr,
