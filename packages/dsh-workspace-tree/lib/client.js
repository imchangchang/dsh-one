...
function SessionRow({
  ...
  const row = (0, import_react11.createElement)(
    "div",
    {
      className: `dshOneTree_sessionRow${(selectMode ? selected : isCurrent) ? " dshOneTree_selected" : ""}${menuOpen ? " dshOneTree_menuOpen" : ""}`,
      role: "treeitem",
...
function WorkspaceTree(props) {
  ...
  return (0, import_react13.createElement)(
    ...
    (0, import_react13.createElement)(
      ...
      trimmedQuery === "" ? (0, import_react13.createElement)(GroupFilterBar, {
        groups: groupDefs,
