...
function indentSubmenuItem(item) {
  ...
  return {
    ...
    // 空 span 塞进去不画东西、只占位。
    icon: record.icon ?? (0, import_react11.createElement)("span", { className: "dshOneTree_submenuIconGap", "aria-hidden": true }),
    label: (0, import_react11.createElement)("span", { className: "dshOneTree_submenuItem" }, record.label ?? null)
  };
}
...
function SessionRow({
  ...
  const row = (0, import_react11.createElement)(
    "div",
    {
      className: `dshOneTree_sessionRow${(selectMode ? selected : isCurrent) ? " dshOneTree_selected" : ""}${menuOpen ? " dshOneTree_menuOpen" : ""}${flat && !showStatus ? " dshOneTree_flatRowWithoutStatus" : ""}`,
      role: "treeitem",
