/**
 * `@dsh-one/dsh-composer-clear` 的浏览器侧入口。
 *
 * 插件本体住在仓库的共享源码里（`src/ui/assembly/shell/composerClearPlugin.ts`），
 ...
 */
export { apply, inject } from '../../../src/ui/assembly/shell/composerClearPlugin.ts'
