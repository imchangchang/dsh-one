...
记录于 2026-09-02。需求两条：① Sessions 面板支持批量选择 session 后一次性归档；② 「未分组」工作区组点右键，可以选择归档该组内所有 session。方案已于 2026-09-02 与用户确认。
...
- 「未分组」组头右键菜单加「归档组内全部」快捷入口：直接进确认框，不用先勾选；禁用项同样不参与。
