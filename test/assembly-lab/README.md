...
#91 加 F-10/F-11、#99 加 F-12、#104 加 F-13、#102 加 F-14、#103 加 F-15、#107 加 F-16、#108 加 F-17、#110 加 F-18、#109 加 F-19、#114 加 F-20、#112 加 F-21 之后共 **22 项 812 条断言**（F-01 43 / F-02 13 / F-03 14 /
F-04 178 / F-05 7 / F-06 11 / F-07 29 / F-08 26 / F-09 13 / F-10 20 / F-11 4 / F-12 28 / F-13 65 / F-14 27 / F-15 63 / F-16 55 / F-17 70 / F-18 34 / F-19 61 / F-20 30 / F-21 20 / R-06 1；
**同一个套件在不同轮次条数会差几条**：F-01 那条右栏断言要当天网关上有合适的会话才跑得到（历史实测跑过 40 与 43 两种计数），F-01…F-21 里凡是依赖当天会话数据的都同理），
本机全绿约 4 分半（F-10 的四棵树靠「fiber 状态静下来」判定，约 10 秒；F-15…F-21 各自要开抽屉、造拖拽、跑批量动作或页内夹具，各约 15~30 秒）。
