...
#91 加 F-10/F-11、#99 加 F-12、#104 加 F-13、#102 加 F-14、#103 加 F-15、#107 加 F-16、#108 加 F-17、#110 加 F-18、#109 加 F-19、#114 加 F-20 之后共 **21 项 791 条断言**（F-01 43 / F-02 13 / F-03 14 /
F-04 178 / F-05 7 / F-06 11 / F-07 29 / F-08 26 / F-09 13 / F-10 20 / F-11 4 / F-12 28 / F-13 65 / F-14 27 / F-15 63 / F-16 55 / F-17 70 / F-18 34 / F-19 60 / F-20 30 / R-06 1，
#114 那一轮实测 788 条：F-01 那轮只跑到 40 条——它的条数随当天**会话数据**浮动，同 F-04/F-13），
本机全绿约 4 分钟（F-10 的四棵树靠「fiber 状态静下来」判定，约 10 秒；F-15/F-16/F-17/F-18/F-19/F-20 各自
要开抽屉、造拖拽或跑批量动作与页内夹具，各约 15~30 秒）。

本机全绿约 3 分钟（F-10 的四棵树靠「fiber 状态静下来」判定，约 10 秒；F-15/F-16 各自
要开抽屉或造拖拽，各约 20~30 秒）。
