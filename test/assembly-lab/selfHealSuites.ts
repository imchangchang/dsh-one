...
import { FRESH_DRIFT, STABLE_DRIFT } from './bootDrift.ts'
...
async function readHeal(page: Page, prefix: string, readySelector: string): Promise<HealReading> {
  return page.evaluate(
    ({ loadKey, selfHealMark, failureMark, driftPrefix, readySelector: selector }) => {
